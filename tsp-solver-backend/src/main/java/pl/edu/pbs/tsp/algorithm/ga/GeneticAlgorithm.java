...
public class GeneticAlgorithm extends Algorithm {
    ...
    /**
     * number of the best individuals from the current generation to carry over to
     * the next
     */
    ...
    protected List<Integer> bestRoute = new ArrayList<>();
    private int epochsNoImprovementCounter = 0;

    public GeneticAlgorithm(int populationSize, int elitismSize, int epochs, int maxEpochsNoImprovement,
            double mutationRate,
    ...
    protected Route solve(double[][] costMatrix) {
        ...
        route.setCitiesOrder((ArrayList<Integer>) bestRoute);
        return route;
    }
    ...
    protected List<Integer> select(List<Individual> individuals) {
    ...
    private List<Integer> crossover(List<Integer> parent1, List<Integer> parent2) {
        ...
        List<Integer> child1 = pmxCrossover ? pmxCrossover(parent1, parent2, index1)
                : orderedCrossover(parent1, parent2, index1, index2);
        List<Integer> child2 = pmxCrossover ? pmxCrossover(parent2, parent1, index1)
                : orderedCrossover(parent2, parent1, index1, index2);
