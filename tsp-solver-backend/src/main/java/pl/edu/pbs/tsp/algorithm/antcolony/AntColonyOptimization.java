...
public class AntColonyOptimization extends Algorithm {
    ...
    private ArrayList<Integer> bestCitiesOrder;
    ...
    private int selectNextCity(Ant ant) {
        ...
        // Rarely happens, when there are a lot of iterations and only one city was left
        // to visit
        // Caused by NaN
        return selectRandomCity(ant);
    }
    ...
    private void updateBest() {
        ...
        for (Ant ant : ants) {
            ...
            if (trailLength < bestTotalCost) {
                ...
                bestCitiesOrder = (ArrayList<Integer>) Arrays.stream(ant.citiesOrder.clone()).boxed()
